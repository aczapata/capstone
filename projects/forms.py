...
class ProjectForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['Resumen'].widget.attrs.update({'class' : 'materialize-textarea',  'length': 2000, 'id': 'textarea1', 'placeholder': 'El resumen debe contener entre 1000 y  2000 caracteres incluyendo espacios'})
        self.fields['Abstract'].widget.attrs.update({'class' : 'materialize-textarea',  'length': 2000, 'id': 'textarea2','placeholder': 'El resumen debe contener entre 1000 y  2000 caracteres incluyendo espacios'})
